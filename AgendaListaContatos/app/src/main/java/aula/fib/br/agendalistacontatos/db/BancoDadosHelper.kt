package aula.fib.br.agendalistacontatos.db

import android.content.Context
import android.database.sqlite.SQLiteDatabase
import aula.fib.br.agendalistacontatos.Constants.CONTATOS_TABLE_DATABASE
...
class BancoDadosHelper(context: Context) :
    ...
    private val scriptSQLCreate = arrayOf(
            ...
            "INSERT INTO $CONTATOS_TABLE_NAME VALUES(5,'bbb@gmail.com','Bbb','R. Camilo José, 48 - Cursino, São Paulo, 04125-140, Brasil',800025774,NULL,'www.uol.com.br',NULL);")
